        ...
        <div>
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-neutral-800/50 border border-neutral-700 text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all"
                />
            </div>
            ...
            <div className="flex flex-col gap-4">
                {memories.map((mem) => (
                    <div key={mem.id} className="rounded-xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-xl p-4 hover:border-neutral-700 transition-colors">
